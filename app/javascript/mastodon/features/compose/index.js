      ...
      header = (
        <nav className='drawer__header'>
          ...
          {!columns.some(column => column.get('id') === 'UNION') && (
            <Link to='/timelines/union' className='drawer__tab' title={intl.formatMessage(messages.union)} aria-label={intl.formatMessage(messages.union)}><Icon id='product-hunt' fixedWidth /></Link>
          )}
