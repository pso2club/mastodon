...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/timelines/union' data-preview-title-id='column.union' data-preview-icon='product-hunt' ><Icon className='column-link__icon' id='product-hunt' fixedWidth /><FormattedMessage id='tabs_bar.union_timeline' defaultMessage='PSO2' /></NavLink>
