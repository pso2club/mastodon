  ...
  render () {
    return (
      <div className='tabs-bar'>
        ...
        <Link className='tabs-bar__link secondary' activeClassName='active' to='/timelines/union'><i className='fa fa-fw fa-handshake-o' /><FormattedMessage id='tabs_bar.union_timeline' defaultMessage='Union' /></Link>
