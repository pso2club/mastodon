...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' to='/timelines/union' data-preview-title-id='column.union' data-preview-icon='product-hunt' ><i className='fa fa-fw fa-product-hunt' /><FormattedMessage id='tabs_bar.union_timeline' defaultMessage='PSO2' /></NavLink>,
