...
const links = [
  ...
  <NavLink className='tabs-bar__link secondary' activeClassName='active' to='/timelines/union'><i className='fa fa-fw fa-product-hunt' /><FormattedMessage id='tabs_bar.union_timeline' defaultMessage='PSO2' /></NavLink>,
