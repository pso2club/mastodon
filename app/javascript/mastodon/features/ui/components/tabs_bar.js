...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' to='/timelines/union' data-preview-title-id='column.union' data-preview-icon='handshake-o' ><Icon id='handshake-o' fixedWidth /><FormattedMessage id='tabs_bar.union_timeline' defaultMessage='Union' /></NavLink>,
