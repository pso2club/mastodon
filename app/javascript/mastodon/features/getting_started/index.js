...
const messages = defineMessages({
  ...
  union_timeline: { id: 'navigation_bar.union_timeline', defaultMessage: 'PSO2 timeline' },
  ...
  render () {
    ...
    if (multiColumn) {
      ...
      if (!columns.find(item => item.get('id') === 'UNION')) {
        navItems.push(<ColumnLink key='3' icon='product-hunt' text={intl.formatMessage(messages.union_timeline)} to='/timelines/union' />);
      }
