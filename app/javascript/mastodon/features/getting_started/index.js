...
export default class GettingStarted extends ImmutablePureComponent {
  ...
  render () {
    ...
    if (!multiColumn || !columns.find(item => item.get('id') === 'DIRECT')) {
      navItems.push(<ColumnLink key='5' icon='envelope' text={intl.formatMessage(messages.direct)} to='/timelines/direct' />);
    }

    navItems.push(
      <ColumnLink key='6' icon='star' text={intl.formatMessage(messages.favourites)} to='/favourites' />,
