...
export const refreshUnionTimeline        = () => refreshTimeline('union', '/api/v1/timelines/union');
...
export const expandUnionTimeline        = () => expandTimeline('union', '/api/v1/timelines/union');
